...
data_dir <- file.path(root_dir, "analyses", "update-histologies-temp", "results")
analysis_dir <- file.path(root_dir, "analyses", "sample-distribution-analysis")
input_dir <- file.path(analysis_dir, "input")

# Inputs
v12_file <- file.path(data_dir, "histologies_2023_11_15.tsv")
...
pbta_pre_df <- readr::read_tsv(v12_file, guess_max = 100000, show_col_types = FALSE) %>%
  filter(cohort == "PBTA",
