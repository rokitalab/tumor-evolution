...
There are `r kids_pbta_samples` patient cases in the PBTA cohort with timepoint information. 
...
There are `r kids_pbta_samples_dna` patient cases in the PBTA cohort with genomic assays.
...
There are `r matched_samples_genomic` patient cases in the PBTA cohort with matched longitudinal samples for genomic assays.
...
There are `r kids_pbta_samples_rna` patient cases in the PBTA cohort with transcriptomic assays.
...
There are `r matched_samples_rna` patient cases in the PBTA cohort with matched longitudinal samples for transcriptomic assays.
...
```
## How many samples have paired assays?
...
```
## How many samples have paired assays and matched longitudinal information?
There are `r matched_samples_paired` patient cases in the PBTA cohort with matched longitudinal samples for genomic and transcriptomic assays.
