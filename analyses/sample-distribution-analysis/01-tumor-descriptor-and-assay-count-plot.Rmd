...
# Outputs
output_pbta <- file.path(results_dir, "pbta.tsv")
output_paired_assays_all <- file.path(results_dir, "paired_assays_all.tsv")

output_genomic_df <- file.path(results_dir, "genomic_df.tsv")
output_transcriptomic_df <- file.path(results_dir, "transcriptomic_df.tsv")
output_paired_assays_all_filter <- file.path(results_dir, "paired_assays_all_filter.tsv")
...
write_tsv(pbta, path = output_pbta)
```
...
# Save paired_assays 
write_tsv(paired_assays_all, path = output_paired_assays_all)
```
...
# Save transcriptomic_df
write_tsv(transcriptomic_df, path = output_transcriptomic_df)
```
...
# Save paired_assays_filter
write_tsv(paired_assays_all_filter, path = output_paired_assays_all_filter)
```
...
Let's summarize this to ensure we capture all tumor samples regardless of diagnosis changes at a lter stage of the disease.
