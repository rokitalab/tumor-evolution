...
There are `r matched_samples_transcriptomic` of patient cases in the PBTA cohort have matched transcriptomic assays.
...
There are `r matched_samples_paired` of patient cases in the PBTA cohort have matched genomic and transcriptomic assays.

## Identify duplicate events - paired assays
We will identify duplicate events. We may want to discard them from further analysis.
