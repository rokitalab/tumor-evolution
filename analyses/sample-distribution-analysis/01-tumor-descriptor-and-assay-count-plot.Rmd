...
# Summary
In the following section, we will provide summary tables across different disease stages, histologies, and patients samples.
...
There are `r matched_samples_rna` of patient cases in the PBTA cohort with matched longitudinal transcriptomic assays.
...
```{r}
paired_assays_matched_ <- paired_assays %>%
  filter(descriptors %in% c("Diagnosis, Recurrence", "Diagnosis, Progressive", "Deceased, Diagnosis", 
