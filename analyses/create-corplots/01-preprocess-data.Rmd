...
no_paired_time_samples <- length(unique(patient_list$Kids_First_Participant_ID))
...
no_paired_time_samples_autopsy <- length(unique(patient_list_metadata$Kids_First_Participant_ID))
```

## Number of patient cases with paired time and autopsy samples

`r no_paired_time_samples` of patient cases have paired time samples in genomic assays and `r no_paired_time_samples_autopsy` have autopsy sample.
