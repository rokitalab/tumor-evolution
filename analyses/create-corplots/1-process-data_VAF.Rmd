...
maf_files_Deceased_subset <- subset(maf_files_Deceased, 
                                    select = c(Kids_First_Biospecimen_ID, match_id, tumor_descriptor, Kids_First_Participant_ID)) 
tmb_merge <- tmb %>% 
  left_join(maf_files_Deceased_subset, by=c('Kids_First_Biospecimen_ID')) %>%
