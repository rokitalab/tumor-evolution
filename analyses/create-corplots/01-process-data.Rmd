...
# split maf data
data <- maf_Deceased %>% 
  filter(descriptors_type == "Diagnosis")
...
# split maf data
data <- maf_Deceased %>% 
  filter(descriptors_type == "Progressive")
...
# split maf data
data <- maf_Deceased %>% 
  filter(descriptors_type == "Recurrence")
...
# split maf data
data <- maf_Deceased %>% 
  filter(descriptors_type == "dx_pro_dec")
...
# split maf data
data <- maf_Deceased %>% 
    filter(descriptors_type == "dx_rec_dec")
...
# split maf data
data <- maf_Deceased %>% 
    filter(descriptors_type == "pro_rec_dec")
