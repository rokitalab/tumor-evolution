...
maf_Deceased <- genomic_assays_matched_time_points_list_merge %>% 
  ...
  filter(!is.na(VAF)) %>%
  mutate(descriptors_type = case_when(grepl("Deceased, Progressive", descriptors) & grepl("Deceased, Progressive, Progressive", descriptors) ~ "Progressive",
                                      ...
                                      grepl("Deceased, Diagnosis, Diagnosis, Progressive, Progressive", descriptors) ~ "dx_pro_dec",
                                      grepl("Deceased, Diagnosis, Recurrence", descriptors) ~ "dx_rec_dec",
                                      grepl("Deceased, Progressive, Recurrence", descriptors) & grepl("Deceased, Progressive, Progressive, Recurrence", descriptors) ~ "pro_rec_dec",
