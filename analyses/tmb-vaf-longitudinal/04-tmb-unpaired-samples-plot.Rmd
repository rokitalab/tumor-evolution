...
f = c("Ependymoma_Diagnosis  (N=113)", "Ependymoma_Progressive  (N=20)" , "Ependymoma_Recurrence  (N=24)", "Ependymoma_Deceased  (N=7)",
      ...
      "Other_Diagnosis  (N=586)", "Other_Progressive  (N=99)", "Other_Recurrence  (N=83)", "Other_Deceased  (N=12)", "Other_Second Malignancy  (N=11)")
