...
for (i in seq_along(cancer_groups)) {
  ...
  # add_xy_position() adds xmin and xmax in order to place the brackets, but those do NOT correspond to the appropriate groups in the plot
  # https://github.com/kassambara/ggpubr/issues/477
  ...
  if(i == 1){
    ...
    p <- print(ggboxplot(df_sub,
          ...
          scale_y_continuous(limits = c(0, max(stat.test$y.position))) +
