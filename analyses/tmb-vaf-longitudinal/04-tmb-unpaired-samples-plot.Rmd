...
# Plot stat.summary
print(ggplot(stat.summary, aes(x = tumor_descriptor,
                               y = tmb,
                               color = tumor_descriptor)) +
        geom_boxplot() +
        ggplot2::scale_color_manual(values = palette, 
...
# Run multiple pairwise comparisons using paired t-tests
...
stat.test <- df_plot %>%
  ...
  pairwise_t_test(
    tumor_descriptor ~ tmb, paired = FALSE, 
