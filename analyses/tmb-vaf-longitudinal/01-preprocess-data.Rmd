...
maf1 <- vroom(maf_file, delim = "\t", col_names = TRUE) %>% 
...
paired_list2 <- tmb_genomic %>%
    unique() %>% 
  dplyr::filter(!Kids_First_Biospecimen_ID %in% bs_missing_tmb$Kids_First_Biospecimen_ID)
