...
# We have also multiple biospecimen samples per tumor descriptor and per Kids_First_Participant_ID
# We will follow similar logic from above with timepoints to create different df for each biospecimen/tumor_descriptor.

# First, let's count number of bs samples per sample and tumor descriptor
count_bs <- maf_autopsy.bind %>% 
  mutate(match_id_kids = paste(Kids_First_Participant_ID, tumor_descriptor, sep = "_")) %>%
