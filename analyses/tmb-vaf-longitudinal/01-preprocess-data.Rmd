...
```{r maf_autopsy}
# We will filter the df to keep paired smaples with Deceased timepoint (autopsy samples).
...
There are `r paired_time_samples_tmb_genomic_filter` patient cases with TMB information (out of the `r paired_time_samples_tmb_genomic`).
