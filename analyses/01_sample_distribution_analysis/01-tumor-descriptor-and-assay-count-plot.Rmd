...
<<<<<<< Updated upstream:analyses/01_sample_distribution_analysis/01-tumor-descriptor-and-assay-count-plot.Rmd
=======
# Save table
HGG <- cohort
...
>>>>>>> Stashed changes:analyses/sample-distribution-analysis/01-tumor-descriptor-and-assay-count-plot.Rmd
```
