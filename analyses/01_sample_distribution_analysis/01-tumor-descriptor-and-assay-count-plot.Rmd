...
data <- hist_cols  %>%
  ...
  mutate(tumor_descriptor = ifelse(sample_id == "C4106355-Tumor" & tumor_descriptor == "Not Reported", "Recurrence", 
                                   ifelse(sample_id == "C4113612-Tumor" & tumor_descriptor == "Initial CNS Tumor", "Recurrence", 
                                          tumor_descriptor)))
...
data$tumor_descriptor <- ifelse(data$tumor_descriptor=="Progressive Disease Post-Mortem", "Deceased",
                                 ifelse(data$tumor_descriptor=="Initial CNS Tumor", "Diagnosis",
                                 ifelse(data$tumor_descriptor=="Primary Tumor", "Diagnosis", data$tumor_descriptor)))
